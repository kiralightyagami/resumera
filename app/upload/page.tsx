...
const handleAnalyze = async ({companyName, jobTitle, jobDescription, file}: {companyName: string, jobTitle: string, jobDescription: string, file: File}) => {
    ...
    if(!uploadedImage) return setStatusText("Failed to upload resume to AI");
    ...
    const feedbackText = typeof feedback === 'string' ? feedback : feedback.message.content[0].text;
            ...
            <div className="page-heading py-16">
                <h1>Smart feedback for your resume</h1>
                {
                    isProcessing ? (
                        ...
                        <h2>Upload your resume for an ATS and improvement tips</h2>
                    )}
                    { !isProcessing && 
